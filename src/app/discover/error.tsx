  ...
  return (
    <main className="flex min-h-[70vh] items-center justify-center bg-background px-5 pt-24 text-center text-foreground">
      <div className="max-w-md">
        <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Discover unavailable</p>
        <h1 className="mt-4 font-display text-4xl sm:text-5xl">The screen went dark.</h1>
        <p className="mt-5 leading-7 text-muted">CineVault could not load the collection right now. Check your connection and try again.</p>
